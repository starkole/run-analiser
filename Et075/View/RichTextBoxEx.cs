...
namespace Et075.View
{
    ...
    class RichTextBoxEx: RichTextBox
    {
        ...
        public void PrintRichTextContents(string printerName)
        {
            PrintDocument printDoc = new PrintDocument();
            printDoc.PrinterSettings.PrinterName = printerName;
            int margine = (int)(15 / 0.254);
            printDoc.DefaultPageSettings.Margins = new Margins(margine, margine, margine, margine);
            if (!printDoc.PrinterSettings.IsValid)
                throw (new MissingMemberException("Could not access printer \"" + printerName + "\"!"));
            printDoc.DocumentName = "Et075 Results";
